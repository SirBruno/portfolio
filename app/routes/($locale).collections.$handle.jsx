...
export const meta = ({ data }) => { return [{ title: `Hydrogen | ${data?.collection.title ?? ''} Collection` }] }
...
export async function loader({ request, context }) {
  ...
  const { collection } = await storefront.query(COLLECTION_QUERY, { variables: { handle: "men", ...paginationVariables }, })
